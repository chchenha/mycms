...
<head>
	...
	<link href="/css/admin/bootstrap-cerulean.css" rel="stylesheet">
...
<body>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.html"> <img alt="Charisma Logo" src="/images/admin//logo20.png" /> <span>Charisma</span></a>
				...
				<div class="btn-group pull-right" >
					...
					<ul class="dropdown-menu">
						...
						<li class="divider"></li>
						<li><a href="/admin/default/logout">Logout</a></li>
					</ul>
				</div>
				<!-- user dropdown ends -->
	...
	<?php }?>
			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link" href="/admin/user/index"><i class="icon-home"></i><span class="hidden-tablet"> <?php echo Yii::t('adminUser','userManage');?></span></a></li>						
						<li><a class="ajax-link" href="/admin/categorie/index"><i class="icon-home"></i><span class="hidden-tablet"> <?php echo Yii::t('adminUser','catManage');?></span></a></li>
						<li><a class="ajax-link" href="/admin/article/index"><i class="icon-eye-open"></i><span class="hidden-tablet"><?php echo Yii::t('adminUser','articleManage');?></span></a></li>
		...
		<?php if(isset(Yii::app()->session['user'])){?>				
		<div class="modal hide fade" id="myDel">
